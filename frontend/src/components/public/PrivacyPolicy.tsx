    ...
    <div className="bg-slate-950 text-white min-h-screen font-sans flex flex-col">
      ...
      <main className="flex-1 max-w-3xl mx-auto w-full px-6 py-12 md:py-20 space-y-8 leading-relaxed font-light text-sm text-slate-300">
        ...
        <section className="space-y-4">
          ...
          <p>
            {isEn
              ? "We work with reputable third-party advertising networks (such as Monetag and other trusted providers) to mediate ad campaigns. These networks may process your IP address and country details to render geographically targeted ads."
              : "Мы работаем с надежными рекламными сетями (например, Monetag и другие проверенные сети). Эти сети могут обрабатывать ваш IP-адрес и данные о стране для показа географически ориентированной рекламы."}
          </p>
        </section>
      </main>
